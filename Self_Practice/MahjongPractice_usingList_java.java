...
class Player{
	...
	public boolean isBasicForm() {
		...
		while (tmpMan.isEmpty()){
			if (manMod==2){ // 머리가 있는 색이면
				boolean existHead = false; // 머리를 찾았는지 체크
				headfinderMan: 
				for (int i = 0; i<tmpMan.size();i++){ 
					for (int j = 0; j<tmpMan.size() ;j++ ){ // 1쌍씩 비교하기 위한 이중for문
			...
			for (int i = 0;i<tmpMan.size() ;i++ ){
				for (int j = i+1;j<tmpMan.size() ;j++){
					for (int k = j+1;k<tmpMan.size() ;k++){ //남은 것 중 3개를 비교해서
						if ((tmpMan.get(i)).isBody((tmpMan.get(j), temMan.get(k)))){ // 몸통이 만들어지면
		...
		while (tmpSak.isEmpty()){
			if (sakMod==2){ // 머리가 있는 색이면
				boolean existHead = false; // 머리를 찾았는지 체크
				headfinderSak: 
				for (int i = 0; i<tmpSak.size();i++){ 
					for (int j = 0; j<tmpSak.size() ;j++ ){ // 1쌍씩 비교하기 위한 이중for문
		...
		while (tmpTong.isEmpty()){
			if (tongMod==2){ // 머리가 있는 색이면
				boolean existHead = false; // 머리를 찾았는지 체크
				headfinderTong: 
				for (int i = 0; i<tmpTong.size();i++){ 
					for (int j = 0; j<tmpTong.size() ;j++ ){ // 1쌍씩 비교하기 위한 이중for문
		...
		while (tmpZa.isEmpty()){
			if (zaMod==2){ // 머리가 있는 색이면
				boolean existHead = false; // 머리를 찾았는지 체크
				headfinderZa: 
				for (int i = 0; i<tmpZa.size();i++){ 
					for (int j = 0; j<tmpZa.size() ;j++ ){ // 1쌍씩 비교하기 위한 이중for문
